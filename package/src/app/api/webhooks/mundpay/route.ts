  ...
  <div style="max-width:480px;margin:40px auto;background:#1a1a2e;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.4);border:1px solid rgba(255,255,255,0.08);">
    ...
    <div style="padding:32px;">
      ...
      <div style="text-align:center;margin:32px 0;">
        <a href="${LOGIN_URL}" style="display:inline-block;background:linear-gradient(135deg,#fe2c55 0%,#d4234a 100%);color:#fff;text-decoration:none;padding:16px 48px;border-radius:12px;font-size:16px;font-weight:700;box-shadow:0 4px 16px rgba(254,44,85,0.3);">
          Click here to access
        </a>
      </div>
      <p style="color:rgba(255,255,255,0.4);font-size:12px;text-align:center;margin:24px 0 0;line-height:1.5;">
        If the button doesn't work, copy and paste this link in your browser:<br>
        <a href="${LOGIN_URL}" style="color:#25f4ee;">${LOGIN_URL}</a>
      </p>
    </div>
