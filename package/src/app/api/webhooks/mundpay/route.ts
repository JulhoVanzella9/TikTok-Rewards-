...
<body style="margin:0;padding:0;background:#0a0a1a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:480px;margin:40px auto;background:#1a1a2e;border-radius:24px;border:1px solid rgba(255,255,255,0.08);">
    <div style="background:linear-gradient(135deg,#fe2c55 0%,#25f4ee 100%);padding:40px 32px;text-align:center;border-radius:24px 24px 0 0;">
    ...
    <div style="padding:32px;">
      ...
      <div style="text-align:center;margin:32px 0;">
        <a href="${loginUrl}" style="display:inline-block;background:linear-gradient(135deg,#fe2c55 0%,#d4234a 100%);color:#fff;text-decoration:none;padding:16px 48px;border-radius:50px;font-size:16px;font-weight:700;">
    ...
    <div style="background:rgba(0,0,0,0.3);padding:20px 32px;text-align:center;border-top:1px solid rgba(255,255,255,0.05);border-radius:0 0 24px 24px;">
