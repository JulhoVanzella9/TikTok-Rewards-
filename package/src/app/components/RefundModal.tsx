            ...
            {step === "legal" ? (
              <>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <WarningIcon />
                    <h3 style={{
                      fontSize: "14px", fontWeight: 800, color: "#FE2C55",
                  ...
                  <div style={{
                    ...
                    <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.55)", lineHeight: 1.6, margin: 0 }}>
                      <strong style={{ color: "#FE2C55" }}>Important:</strong> By proceeding, you acknowledge that your account activity, access logs, IP addresses, and device information have been recorded and may be used as evidence in the event of a dispute or chargeback.
                    </p>
                  </div>
              ...
              <>
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: "12px", color: "#FE2C55", lineHeight: 1.7, marginBottom: "10px", textAlign: "left", fontWeight: 600 }}>
                  ...
                  <div style={{ paddingLeft: "4px", marginBottom: "14px" }}>
                    {[
                      ...
                      <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "8px", marginBottom: "8px" }}>
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#FE2C55" strokeWidth="2" style={{ marginTop: "3px", flexShrink: 0 }}>
                  ...
                  >
                    <input
                      ...
                      style={{
                        ...
                        marginTop: "2px", accentColor: "#FE2C55",
              ...
              <div style={{
                ...
                {submitted ? (
                  <div style={{ textAlign: "center", padding: "20px 0" }}>
                    ...
                    <button
                      type="button"
                      onClick={() => { window.location.href = "/refund/status"; }}
                      className="btn-3d btn-3d-dark"
                      style={{ fontFamily: "inherit", width: "100%", marginTop: "14px" }}
                    >
                      Check Refund Status
                    </button>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    {existingRequests.filter(r => r.status === 'pending' || r.status === 'processing').length > 0 && (
                      <div style={{
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                          ...
                          <span style={{ fontSize: "13px", fontWeight: 600, color: "#FE2C55" }}>Refund already in progress</span>
                        </div>
                    ...
                    {duplicateError && (
                      <div style={{
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                          ...
                          <span style={{ fontSize: "13px", fontWeight: 600, color: "#FE2C55" }}>{duplicateError}</span>
                        </div>
                      </div>
                    )}
                    ...
                    <div style={{
                      ...
                      padding: "12px", background: "rgba(254,44,85,0.08)",
                      borderRadius: "10px", border: "1px solid rgba(254,44,85,0.2)",
                      marginBottom: "20px",
                    }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FE2C55" strokeWidth="2" style={{ flexShrink: 0, marginTop: "1px" }}>
