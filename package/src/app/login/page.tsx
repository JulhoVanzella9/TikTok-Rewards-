          ...
          >
            {isForgotPassword ? (
              ...
              <svg width="70" height="70" viewBox="0 0 48 48" fill="none">
                ...
                {/* White main layer */}
                <path d="M38.42 13.3a11.53 11.53 0 01-6.42-1.93 11.5 11.5 0 01-4.2-5.37h-6.3v27.18c0 3.67-2.97 6.64-6.64 6.64s-6.64-2.97-6.64-6.64 2.97-6.64 6.64-6.64c.73 0 1.43.12 2.08.34v-6.42a13.06 13.06 0 00-2.08-.17C8.07 20.29 2.5 25.86 2.5 32.65c0 6.79 5.57 12.35 12.36 12.35 6.79 0 12.36-5.56 12.36-12.35V19.83A17.78 17.78 0 0038.42 24V17.6c0 0 0-4.3 0-4.3z" fill="#fff"/>
              </svg>
            )}
          </div>
