    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", paddingBottom: "100px" }}>
      ...
      <div style={{
        ...
        <motion.button
          ...
          style={{
            background: showList ? "rgba(254,44,85,0.15)" : (isDarkMode ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.05)"),
            border: showList ? "1px solid rgba(254,44,85,0.3)" : `1px solid ${isDarkMode ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.1)"}`,
            borderRadius: "20px", padding: "8px 16px", cursor: "pointer",
            color: showList ? "#fe2c55" : (isDarkMode ? "#fff" : "#333"), fontSize: "13px", fontWeight: 600, fontFamily: "inherit",
            display: "flex", alignItems: "center", gap: "8px",
            transition: "all 0.2s",
          }}
        >
                        ...
                        >
                          <div style={{
                            ...
                            <div style={{
                              ...
                              background: isActive ? "#fe2c55" : isCompleted ? "#25f4ee" : (isDarkMode ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.06)"),
        ...
        <motion.div
          ...
          style={{
            ...
            background: isDarkMode
              ? "linear-gradient(145deg, rgba(254,44,85,0.05) 0%, transparent 100%)"
              : "linear-gradient(145deg, rgba(254,44,85,0.03) 0%, transparent 100%)",
            minHeight: "200px",
          }}
        >
          <div style={{
            ...
            <div style={{
              ...
              background: isDarkMode ? "#000" : "#FE2C55",
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: isDarkMode ? "0 4px 20px rgba(0,0,0,0.4)" : "0 4px 20px rgba(254,44,85,0.25)",
              border: `1px solid ${isDarkMode ? "rgba(255,255,255,0.1)" : "rgba(254,44,85,0.2)"}`,
            }}>
