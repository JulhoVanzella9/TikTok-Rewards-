...
const activityData: ActivityItem[] = [
  ...
  { id: "3", type: "lesson", title: "Aula Assistida", description: "Algoritmo do TikTok - TikTok Growth Mastery", icon: "▶️", time: "Ontem, 21:15", color: "#fe2c55" },
  ...
  { id: "6", type: "course", title: "Curso Concluído!", description: "TikTok Growth Mastery - Todas as aulas completas", icon: "🎓", time: "3 dias atrás", color: "#25f4ee" },
  { id: "7", type: "lesson", title: "Aula Assistida", description: "Análise de Métricas - TikTok Growth Mastery", icon: "▶️", time: "3 dias atrás", color: "#fe2c55" },
